  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl w-full mx-auto px-6 md:px-10 lg:px-12 py-20 flex flex-col gap-12">
        ...
        >
          <motion.div
            className="relative w-[160px] h-[160px] md:w-[200px] h-[200px]
        ...
        "
          ...
          "
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              ...
              Python, React, SvelteKit, JavaScript, Tailwind CSS, and
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed text-base sm:text-lg">
            Software Developer and Web Developer with a strong interest in data
            analysis, focused on building efficient web applications and
            extracting insights through Python, SQL, and Power BI.
          </p>
